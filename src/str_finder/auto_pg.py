...
class CasualPatternsGenerator:
    ...
    def __generate_patterns(self):
        ...
        while True:
            ...
            self._patterns[cur_level] = sorted(
                [p for p, _ in promoted_patterns])
